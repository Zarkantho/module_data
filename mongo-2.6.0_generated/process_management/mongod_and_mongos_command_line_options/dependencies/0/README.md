...
<div></div>
    ...
    mongo::optionenvironment::OptionsParser::run(mongo::optionenvironment::OptionSection const&, std::vector<std::string, std::allocator<std::string> > const&, std::map<std::string, std::string, std::less<std::string>, std::allocator<std::pair<std::string const, std::string> > > const&, mongo::optionenvironment::Environment*)
...
<div></div>
    ...
    vtable for mongo::optionenvironment::OptionsParser
...
<div></div>
    ...
    typeinfo for mongo::optionenvironment::OptionsParser
