...
- src/mongo/s/bson\_serializable.h   (mongod, cppclientdriver, tools, mongos)
...
- src/mongo/s/chunk\_version.h   (mongod, cppclientdriver, tools, mongos)
...
- src/mongo/s/commands/cluster\_hint\_cmd.cpp   (mongos)
...
- src/mongo/s/shard.h   (mongod, cppclientdriver, tools, mongos)
...
- src/mongo/s/stale\_exception.h   (mongod, cppclientdriver, tools, mongos)
