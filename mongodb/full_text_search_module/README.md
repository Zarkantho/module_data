...
<div></div>
    ...
    mongo::fts::FTSCommand::addRequiredPrivileges(std::string const&, mongo::BSONObj const&, std::vector<mongo::Privilege, std::allocator<mongo::Privilege> >*)
...
<div></div>
    ...
    mongo::fts::FTSCommand::run(std::string const&, mongo::BSONObj&, int, std::string&, mongo::BSONObjBuilder&, bool)
