...
- src/mongo/db/dbmessage.h   (mongod, cppclientdriver, tools, mongos)
...
- src/mongo/db/lasterror.h   (mongod, cppclientdriver, tools, mongos)
...
# Files
- src/mongo/client/export\_macros.h   (mongod, cppclientdriver, tools, mongos)
- src/mongo/client/undef\_macros.h   (mongod, cppclientdriver, tools, mongos)
- src/mongo/client/redef\_macros.h   (mongod, cppclientdriver, tools, mongos)
...
- src/mongo/client/gridfs.h   (cppclientdriver, tools)
